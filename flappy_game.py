...
class FlappyBird:
    ...
    def getMatrix(self):
        ...
        color_map = {
            ...
            self.BIRD_BODY: (0, 0, random.randint(100, 255)),
            self.PIPE: (0, 0, random.randint(100, 255)),
            self.PAVEMENT: (0, 0, random.randint(100, 255)),
            self.GAME_OVER: (0, 0, random.randint(100, 255)),
        }
